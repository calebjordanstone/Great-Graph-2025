var jsPsychHtmlKeyboardResponseMLP = (function (jspsych) {
  'use strict';
   ...
   */
  class HtmlKeyboardResponseMLPPlugin {
      constructor(jsPsych) {
  ...
  HtmlKeyboardResponseMLPPlugin.info = info;

  return HtmlKeyboardResponseMLPPlugin;
